...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="coreaudio_ts_soundbackend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25coreaudio_ts_soundbackend11Audio_IO_v3") SWIFT_AVAILABILITY(ios,introduced=10.0)
